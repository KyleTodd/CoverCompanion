export const policyTypes = [
    ...
    {value: "TRADECR", label: "TRADECR - Trade Credit Insurance"},
...
//     'MVP': 'mingcute:car-fill',
//     'HH': 'ion:home',
//     'MVC':'bxs:truck',
//     'LD':'solar:home-bold',
//     'BUS':'ic:round-business',
//     'CROP':'lucide:wheat',
//     'default': 'ep:question-filled',
//     };

export const iconMapping = {
    'ASSOCIATIO': 'ic:baseline-people',
    'BINT': 'ic:outline-business',
    'BOIL': 'ph:flame-bold',
    'BURG': 'ic:round-security',
    'BUS': 'ic:round-business',
    'BWACT': 'mdi:hammer-wrench',
    'BWNSW': 'mdi:hammer-wrench',
    'COMP': 'mdi:desktop-classic',
    'COMSTRUCT': 'mdi:office-building',
    'CONS': 'fa-solid:hard-hat',
    'CROP': 'lucide:wheat',
    'CVAN': 'ic:baseline-directions-car',
    'CYB': 'mdi:security',
    'CYBER': 'mdi:security',
    'D&O': 'mdi:briefcase',
    'FARM': 'ic:outline-agriculture',
    'FEE ONLY': 'ic:outline-attach-money',
    'FIRE': 'ph:flame-bold',
    'FLEET': 'ic:baseline-directions-car',
    'FMOT': 'fa-solid:tractor',
    'GENP': 'ic:outline-home-repair-service',
    'GNL': 'ic:baseline-gavel',
    'HH': 'ion:home',
    'HOME': 'ion:home',
    'ISR': 'mdi:factory',
    'IT PI': 'mdi:briefcase-outline',
    'JEWBLO': 'ph:diamond-bold',
    'LD': 'solar:home-bold',
    'LEGALEXP': 'ic:outline-description',
    'LIAB': 'ic:baseline-gavel',
    'LIVE': 'ic:baseline-pets',
    'LL': 'mdi:office-building',
    'LLCOMM': 'mdi:office-building',
    'LOSS': 'ic:outline-local-fire-department',
    'MACH': 'ic:outline-construction',
    'MANAGEMENT': 'ic:outline-business',
    'MAR': 'mdi:ferry',
    'MARINE': 'mdi:ferry',
    'MC': 'ic:baseline-two-wheeler',
    'MNL': 'mdi:briefcase-outline',
    'MON': 'mdi:cash',
    'MVC': 'bxs:truck',
    'MVP': 'mingcute:car-fill',
    'MVT': 'bxs:truck',
    'OWNER BUIL': 'mdi:home-account',
    'PERS': 'mdi:account',
    'PI': 'mdi:file-document',
    'PI OVERSEA': 'mdi:file-document',
    'PLEA': 'mdi:sail-boat',
    'PLNT/EQUIP': 'mdi:forklift',
    'PR': 'tabler:truck-return',
    'RD': 'ic:outline-agriculture',
    'RESBUILWAR': 'mdi:home-city',
    'RESBUWAROT': 'mdi:home-city-outline',
    'RET': 'mdi:store',
    'RU': 'ic:outline-agriculture',
    'STRCOM': 'mdi:office-building',
    'STRRES': 'mdi:office-building',
    'TAX': 'ic:outline-attach-money',
    'TAXIMETRO': 'mdi:taxi',
    'TAXIREG': 'mdi:taxi',
    'TAXIREGLIA': 'mdi:taxi',
    'TENP': 'mdi:home-account',
    'TP': 'mdi:car',
    'TRADECR': 'mdi:cash-check',
    'TRAV': 'ic:outline-flight',
    'UNRG': 'mdi:tractor',
    'VACANTLAND': 'mdi:home-remove',
    'VAL': 'ph:diamond-bold',
    'VOLW': 'mdi:account',
    'WCOV': 'mdi:worker',
    'default': 'ep:question-filled',
    ...
    export const getLabel = (value) => {
        const policyType = policyTypes.find(policy => policy.value === value);
        return policyType ? policyType.label.split(' - ')[1] : '';
    }