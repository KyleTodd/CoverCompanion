...
<div class="d-flex justify-content-end" style="color:grey;" href="#">Beta 1.0.0</div>
  ...
  <div class="container-fluid mt-4">
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link" href="#" class:active={activeTab === 'uploadpolicy'} on:click={() => activeTab = 'uploadpolicy'}>Upload Policy</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" class:active={activeTab === 'adduser'} on:click={() => activeTab = 'adduser'}>Add User</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" class:active={activeTab === 'addlinkeduser'} on:click={() => activeTab = 'addlinkeduser'}>Add Linked User</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" class:active={activeTab === 'updateuser'} on:click={() => activeTab = 'updateuser'}>Update User</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" class:active={activeTab === 'updatepolicies'} on:click={() => activeTab = 'updatepolicies'}>Update / View Policies</a>
        </li>
    </ul>
